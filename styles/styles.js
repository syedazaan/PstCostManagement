...
marginRight4:{
    ...
    bgcardGray1:{
        backgroundColor: Colors.graycard1,
    },
  ...
  bgbox1:{
      backgroundColor:Colors.box1pink,
  },

  bgbox2:{
      backgroundColor:Colors.box2pink,
  },

  bgbox3:{
      backgroundColor:Colors.box3orange,
  },

  bgbox4:{
      backgroundColor:Colors.box4yellow,
  },

  bgbox5:{
      backgroundColor:Colors.box5pink,
  },
bgprogresback:{
    backgroundColor:Colors.progressback,
},
bgprogresspink:{
    backgroundColor:Colors.progresspink,
},

bgBarGrey: {
    backgroundColor:Colors.barBottomGrey,
},
bgSmallGrey: {
    backgroundColor:Colors.exerciseGrey,
},
bgDarkOrange: {
...
bgLightOrange:{
    backgroundColor:Colors.boxLightorange,
},
bgCMLightBlue:{
    backgroundColor:Colors.boxLightBlueCM,
},
bgCMLightPurple:{
    backgroundColor:Colors.boxLightPurpleCM,
},
...
marginleft20:{
 ...
 bgGreyIcon:{
     backgroundColor: Colors.greysmall,
 },

 bgContentGrey:{
     backgroundColor:Colors.contentLightGrey,
 },
