        ...
        return (
            <View style = {styles1.container}>
                ...
                <TouchableOpacity 
                    ...
                    style = {[styles.flexQuarterToOne, styles.Margin20, styles.justifyContentCenter, styles.bottomHorizontal, styles.border]}>
                        <Text style = {[styles.fontSize19]}>Login</Text>
                </TouchableOpacity>
                {/* Swiper_block */}
                ...
                <View style = {[styles.flexFour, styles.border]}>
                    ...
                    <View style = {[styles.flexQuarterToOne, styles.allCenter, styles.paddingTop20, styles.border]}>
                        <Text style = {[styles.fontSize19, styles.fontWeightBold,]}>Support Constant</Text>                        
                    </View>
                    {/* Contrary_block */}
